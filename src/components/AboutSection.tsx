        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-4">
            <p className="text-lg leading-relaxed text-gray-300">
              In rural Bengal, small boats like the 'Deenga' gracefully sail through the river branches, echoing the spirit of folk life. Inspired by these boats, Deenga began its musical journey on 10th January 2002. Much like boatmen singing Bhatiali, our music carries the essence of Bengal's folk traditions. We blend the sounds of Chatka, Jhumur, Bhavaiyya, Lalon Fakir, and Rabindranath Tagore. With modern instruments as our oars, Deenga ferries these timeless tunes to new shores.
            </p>
            <p className="text-lg leading-relaxed text-gray-300">
