...
const AlbumSection = () => {
  const albums = [
    ...
    },
    {
      ...
      title: "Ghum Bhangche",
      year: 2023,
      coverImage: "/lovable-uploads/522b9628-301f-490a-bd2a-3dcaa470fc51.png",
              ...
              <div className="grid md:grid-cols-3 gap-8 items-center">
                ...
                <div className="md:col-span-2">
                  ...
                  <a 
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-deenga-dark text-white rounded-full hover:bg-deenga-purple transition-colors duration-300"
                  >
